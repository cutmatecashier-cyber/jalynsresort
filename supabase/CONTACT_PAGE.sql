-- Contact page hero + content backgrounds (run in Supabase SQL Editor)
-- Same storage pattern as scuba-diving: public bucket, folders hero/ and content/,
-- stable file name current.{ext}. Safe to re-run.
