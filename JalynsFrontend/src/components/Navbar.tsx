...
const links: NavItem[] = [
  ...
  { label: "Rooms and Apartments", kind: "hash", hash: "#rooms" },
  { label: "Restaurant", kind: "hash", hash: "#restaurant" },
  { label: "Scuba Diving", kind: "hash", hash: "#diving" },
  { label: "SPA", kind: "hash", hash: "#spa" },
  { label: "News, Offers and Events", kind: "hash", hash: "#news" },
  { label: "Contact Us", kind: "route", to: "/contact" },
];
